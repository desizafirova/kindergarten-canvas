...
export const bg: Translations = {
  ...
  publicEvents: {
    ...
    notFound: 'Събитието не е намерено',
    backToList: '← Назад към събитията',
    importantLabel: 'Важно събитие',
    multiDayLabel: 'до',
    locationLabel: 'Място',
  },
  publicDeadlines: {
    ...
    notFound: 'Срокът не е намерен',
    backToList: '← Назад към сроковете',
    urgentLabel: 'Спешен срок',
    countdownLabel: 'Остават',
    countdownDaysSingular: 'ден',
    countdownDaysPlural: 'дни',
    countdownLessThanDay: 'по-малко от ден',
  },
  publicJobs: {
