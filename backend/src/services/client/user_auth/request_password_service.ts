 ...
 *
 * NOTE: Email-based password reset is NOT supported in this project.
...
const errorMsg = 'Email-based password reset is not supported. Contact system administrator.';

export default async (_data: any) => {
    // Password reset via email disabled - simplified User schema
